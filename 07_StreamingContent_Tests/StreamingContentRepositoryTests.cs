...
namespace _07_StreamingContent_Tests
{
    ...
    public class StreamingContentRepositoryTests
    {
        ...
        public void AddToDirectory_ShouldGetCorrectBoolean()
        {
            ...
            //Act
            bool addResult = repository.AddContentToDirtectory(content);
        ...
        public void GetDirectory_ShouldReturnCorrectCollection()
        {
            ...
            StreamingContent content = new StreamingContent();
            StreamingContentRepository repository = new StreamingContentRepository();
            repository.AddContentToDirtectory(content);
            // Act
        ...
        public void Arrange()
        {
            ...
            _repo.AddContentToDirtectory(_content);
        }

        [TestMethod]
        public void CheckMovieRunTime()
        {
            // Creating a movie type, using full constuctor and inherited base
        ...
        [TestMethod]
        public void UpdateExistingContent_ShouldUpdateValue()
        {
            //Arrange
